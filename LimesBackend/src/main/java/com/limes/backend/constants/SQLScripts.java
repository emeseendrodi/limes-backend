...
public class SQLScripts {
    ...
    public final static String GET_EXISTS_MORE_ASSIGNMENT_IN_WEEKLY_LECTURE_BY_ASSIGNMENT_ID = "select exists(select * from assignment a where a.weekly_lecture_id = (select a2.weekly_lecture_id from assignment a2 where a2.id = %d) and a.id > %d and a.is_test_assignment = false)";
